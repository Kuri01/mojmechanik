...
const mockReservations = [
    ...
    },
    {
        id: 2,
        workshop: {
            image: 'https://st4.depositphotos.com/28384682/41602/i/450/depositphotos_416026580-stock-photo-repairer-consults-with-a-colleague.jpg',
            name: 'MOTO-TECH',
        },
        car: {
            image: 'https://example.com/car_image.jpg',
...
const MyReservations = () => {
    ...
    return (
        <Container sx={{ marginTop: '32px', marginBottom: '32px' }}>
                            ...
                            <StyledCard>
                                ...
                                <StyledCardContent>
                                    ...
                                    <Typography variant='body2' color='text.secondary'>
                                        Model: {reservation.car.model}, Brand: {reservation.car.brand}
                                    </Typography>
                                    <Typography variant='body2' color='text.secondary'>
            ...
            <DeleteDialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)} onConfirm={handleDeleteSubmit} />
        </Container>
    );
};
