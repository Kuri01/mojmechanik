...
/**
 * Komponent wyszukiwarki warsztatów.
 *
 * @component
 * @returns {JSX.Element} Zwraca komponent wyszukiwarki warsztatów.
 */
...
const Search = () => {
  ...
  /**
   * Funkcja obsługująca zmianę wartości w polu wyszukiwania.
   *
   * @param {Event} event - Zdarzenie zmiany wartości.
   */
  ...
  /**
   * Funkcja otwierająca dialog szczegółów warsztatu.
   *
   * @param {Object} workshop - Wybrany warsztat.
   */
  ...
  /**
   * Funkcja otwierająca dialog kalendarza warsztatu.
   *
   * @param {Object} workshop - Wybrany warsztat.
   */
  ...
  /**
   * Funkcja zamykająca dialog szczegółów warsztatu.
   */
  ...
  /**
   * Funkcja zamykająca dialog kalendarza warsztatu.
   */
    ...
    <>
      <Container>
        ...
        <Grid container spacing={3} sx={{ mt: 3 }}>
          ...
          {error && (
            <Alert severity="error">Nie udało się pobrać warsztatów</Alert>
          )}
