...
const allHours = ['09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00'];
...
const WorkshopCalendarDialog = ({ open, onClose, workshop }) => {
    ...
    const fetchOccupiedHours = useCallback(
        async (date) => {
            ...
            try {
                ...
                setAvailableHours(allHours.filter((hour) => !occupiedHours.includes(hour)));
            } catch (error) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            enqueueSnackbar('Wystąpił błąd podczas zapisywania rezerwacji', { variant: 'error' });
        } finally {
                ...
                <Box display='flex'>
                    <Box flex={1} marginRight={2}>
                        ...
                        <StaticDatePicker
                            ...
                            maxDate={maxDate}
                            renderInput={(params) => (
                                <TextField {...params} error={!!errors.selectedDate} helperText={errors.selectedDate?.message} />
                            )}
                        />
